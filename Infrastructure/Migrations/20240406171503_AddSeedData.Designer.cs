...
namespace GoalsetterChallenge.Infrastructure.Migrations
{
    ...
    [Migration("20240406171503_AddSeedData")]
            ...
            modelBuilder.Entity("GoalsetterChallenge.Domain.Entities.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            EndDate = new DateTime(2024, 4, 13, 14, 15, 3, 456, DateTimeKind.Local).AddTicks(8669),
                            StartDate = new DateTime(2024, 4, 6, 14, 15, 3, 456, DateTimeKind.Local).AddTicks(8660),
                            VehicleId = 1
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            EndDate = new DateTime(2024, 4, 13, 14, 15, 3, 456, DateTimeKind.Local).AddTicks(8673),
                            StartDate = new DateTime(2024, 4, 6, 14, 15, 3, 456, DateTimeKind.Local).AddTicks(8673),
                            VehicleId = 6
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            EndDate = new DateTime(2024, 4, 13, 14, 15, 3, 456, DateTimeKind.Local).AddTicks(8674),
                            StartDate = new DateTime(2024, 4, 6, 14, 15, 3, 456, DateTimeKind.Local).AddTicks(8674),
                            VehicleId = 3
                        });
                });
